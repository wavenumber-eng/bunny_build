...
#ifndef BUNNY_BUILD_INSTR_H
#define BUNNY_BUILD_INSTR_H
...
extern void  E_GOSUB(const char* a30);
...
extern void  E_GOTO(const char* a21);

extern void  E_GOTO_REG(uint32_t raddr);

extern void  E_GOTOL(const char* a21);

extern void  E_GOTO_REGL(uint32_t raddr);

extern void  E_COND_GOTO(uint32_t cond, const char* a21);

extern void  E_COND_GOTO_REG(uint32_t cond, uint32_t raddr);

extern void  E_COND_GOTOL(uint32_t cond, const char* a21);

extern void  E_COND_GOTO_REGL(uint32_t cond, uint32_t raddr);
