...
pin_labels:
- {pin_num: '83', pin_signal: PIO0_3/FC3_RXD_SDA_MOSI_DATA/CTIMER0_MAT1/SCT0_OUT1/SCT_GPI3/SECURE_GPIO0_3, label: EZH_TEST, identifier: EZH_TEST}
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t EZH_TEST_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO0_3 (pin 83)  */
    GPIO_PinInit(BOARD_INITPINS_EZH_TEST_GPIO, BOARD_INITPINS_EZH_TEST_PORT, BOARD_INITPINS_EZH_TEST_PIN, &EZH_TEST_config);
