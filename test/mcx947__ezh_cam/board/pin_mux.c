...
- {pin_num: G4, pin_signal: PIO1_18/FREQME_CLK_IN0/FC5_P2/FC3_P6/CT3_MAT0/SCT0_IN6/FLEXIO0_D26/PLU_IN4/ENET0_COL/CAN0_TXD/ADC1_A18, label: 'P1_18/J9[6]', identifier: CAM_PDWN}
...
- {pin_num: G5, pin_signal: PIO1_19/WUU0_IN15/FREQME_CLK_IN1/FC5_P3/CT3_MAT1/SCT0_IN7/FLEXIO0_D27/PLU_IN5/ENET0_CRS/CAN0_RXD/ADC1_A19, label: 'P1_19/J9[5]', identifier: CAM_RST}
...
- pin_list:
  ...
  - {pin_num: C14, peripheral: SYSCON0, signal: CLKOUT, pin_signal: PIO0_6/ISPMODE_N/FC0_P2/FC1_P6/CT_INP2/HSCMP2_OUT/PDM0_DATA1/CLKOUT/TSI0_CH10, identifier: ''}
  - {pin_num: B12, peripheral: SMARTDMA0, signal: 'TRIG, 0', pin_signal: PIO0_10/FC0_P6/CT0_MAT0/FLEXIO0_D2/ADC0_B10, identifier: ''}
...
void BOARD_InitDEBUG_UARTPins(void)
{
    ...
    GPIO_PinInit(BOARD_INITDEBUG_UARTPINS_CAM_PDWN_GPIO, BOARD_INITDEBUG_UARTPINS_CAM_PDWN_PIN, &CAM_PDWN_config);
    ...
    GPIO_PinInit(BOARD_INITDEBUG_UARTPINS_CAM_RST_GPIO, BOARD_INITDEBUG_UARTPINS_CAM_RST_PIN, &CAM_RST_config);
    ...
    PORT_SetPinMux(BOARD_INITDEBUG_UARTPINS_CAM_PDWN_PORT, BOARD_INITDEBUG_UARTPINS_CAM_PDWN_PIN, kPORT_MuxAlt0);
    ...
    PORT_SetPinMux(BOARD_INITDEBUG_UARTPINS_CAM_RST_PORT, BOARD_INITDEBUG_UARTPINS_CAM_RST_PIN, kPORT_MuxAlt0);
