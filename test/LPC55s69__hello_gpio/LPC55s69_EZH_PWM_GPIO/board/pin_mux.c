...
void BOARD_InitPins(void)
{
    ...
    // >>> configure pins
    IOCON->PIO[0][KEY_ROW_1]             = PINFUNC_EZH | 2<<4 | 1<<8;
    IOCON->PIO[0][KEY_ROW_2]            = PINFUNC_EZH | 2<<4 | 1<<8;
    IOCON->PIO[0][KEY_ROW_3]             = PINFUNC_EZH | 2<<4 | 1<<8;
    IOCON->PIO[0][KEY_ROW_4]             = PINFUNC_EZH | 2<<4 | 1<<8;
    IOCON->PIO[0][KEY_COLUMN_1]        = PINFUNC_EZH |2<<4 | 1<<14| 1<<8;
//        IOCON->PIO[0][KEY_COLUMN_2]     = PINFUNC_EZH | 1<<14| 1<<8;
    IOCON->PIO[0][KEY_COLUMN_2]     = 0xF |2<<4 | 1<<14| 1<<8;
    IOCON->PIO[0][KEY_COLUMN_3]     = PINFUNC_EZH | 2<<4 | 1<<8;
    IOCON->PIO[0][KEY_COLUMN_4]        = PINFUNC_EZH | 2<<4 | 1<<8;
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
